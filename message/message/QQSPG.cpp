...
void QQSPG::RecommendFriend()
{
	...
	for (; it != all_friends_list.end(); ++it)
	{
		if ((*it)->is_qq_friend_ == 0 && ((*it)->is_wechat_friend_ == 1
...
void QQSPG::JoinGroup()
{
	...
	{
		if (group_id == (*it)->group_id_ && (*it)->is_qq_member_ == 0)
		{
			flag = true;
